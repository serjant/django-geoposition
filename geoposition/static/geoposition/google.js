    ...
    $(document).ready(function() {
        ...
        $('.geoposition-widget').each(function() {
            var $container = $(this),
                ...
                $placeholderText = 'Input an address...',
                $searchInput = $('<input>', {'type': 'text', 'placeholder': django.gettext !== undefined ? django.gettext($placeholderText) : gettext($placeholderText)}),
